...
Uses real handwritten data from MNIST (digits) and EMNIST (letters)
instead of synthetic font-rendered characters.

Classes (17 total, matching HexaSudoku):
- 0: Empty cell
- 1-9: Digits 1-9
- 10-15: Letters A-F (representing values 10-15)
- 16: Unused
...
# Constants
IMG_SIZE = 28
NUM_CLASSES = 17  # 0-9 digits + A-F letters + empty
EPOCHS = 30
BATCH_SIZE = 64
LEARNING_RATE = 0.001
