...
|-------|--------|---------|
| Training | MNIST train + EMNIST train | CNN model training |
| Test | MNIST test + EMNIST test | Board image generation |
...
| Metric | Synthetic (HexaSudoku) | Handwritten |
|--------|------------------------|-------------|
| Extraction Accuracy | 100% | 98.89% |
| Valid Solutions | 100% | 6% |
| Exact Matches | 100% | 6% |
