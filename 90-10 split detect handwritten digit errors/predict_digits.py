"""
Extended Error Correction using Top-K CNN Predictions.
...
def attempt_correction_with_top_k(
    ...
    if max_attempts_per_level is None:
        ...
        max_attempts_per_level = [50, 200, 500, 1000, 2000]
...
def main():
    ...
    if all_results:
        ...
        with open(summary_path, 'w') as f:
            f.write("Extended Error Correction (Top-K CNN Predictions)\n")
