"""
Generate board images for unique HexaSudoku puzzles.
"""
import json
import os
...
def value_to_char(value):
    ...
    if value <= 9:
        return str(value)
    return chr(ord('A') + value - 10)  # 10→A, 11→B, ..., 16→G
...
def main():
    ...
    print(f"Loaded {len(puzzles)} unique puzzles")
    ...
    output_dir = './unique_board_images'
