"""
Extended Error Correction using Top-K CNN Predictions (95-5 Split).
...
Note: This version uses models trained with 95-5 split (5700/300 per class).
"""
...
def main():
    ...
    print("95-5 Split with Enhanced CNN Training")
    ...
    # Use 95-5 trained model
    hex_model_path = os.path.join(base_dir, "models/handwritten_hex_cnn.pth")

    # Use local board_images (generated from 95-5 split test data)
    ...
    if all_results:
        ...
        with open(summary_path, 'w') as f:
            f.write("Extended Error Correction (Top-K CNN Predictions) - 95-5 Split\n")
