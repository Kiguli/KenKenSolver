"""
Generate HexaSudoku board images using handwritten TEST samples (95-5 Split).
...
Note: Uses 95-5 split test data (300 samples per class), which is a
DIFFERENT set than the 90-10 split test data due to different random seed.
...
# Use same random seed as download for consistency
...
def load_test_samples():
    ...
    print(f"Loaded {len(test_images)} test samples (95-5 split)")
...
def main():
    ...
    print("95-5 Split (Different test set from 90-10)")
    print("=" * 60)
    ...
    print("   (Different samples than 90-10 split due to seed 9505)")
    print("-" * 60)
